...
public class SolrInMeta extends BaseStepMeta implements StepMetaInterface {
	...
	@Override
	public void readRep(Repository rep, ObjectId id_step, List<DatabaseMeta> arg2, Map<String, Counter> arg3)
	...
	@Override
	public void check(List<CheckResultInterface> remarks, TransMeta arg1, StepMeta stepMeta, RowMetaInterface arg3,
		...
		if (input.length > 0) {
			cr = new CheckResult(CheckResult.TYPE_RESULT_OK,
					Messages.getString("SolrInMeta.CheckResult.ReceivingInfoFromOtherSteps"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		} else {
			cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR,
					Messages.getString("SolrInMeta.CheckResult.NoInpuReceived"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		}
	}
